...
import com.jackie.bookpagerview.camera.CameraActivity;
...
public class ShowGridAdapter extends BaseAdapter{
    ...
    public ShowGridAdapter(Context context, ArrayList<ImageBean> mList){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(new File(mList.get(position).getPath())).error(R.mipmap.personal_add).into(viewHolder.imageview);
